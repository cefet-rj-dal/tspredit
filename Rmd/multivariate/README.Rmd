...
- [16-stock-close-torch-ts-mlp-regression.md](16-stock-close-torch-ts-mlp-regression.md) - keep the stock scenario fixed and use a PyTorch MLP as the target learner.
- [17-stock-close-conv1d-regression.md](17-stock-close-conv1d-regression.md) - keep the stock scenario fixed and use Conv1D as the target learner.
- [18-stock-close-lstm-regression.md](18-stock-close-lstm-regression.md) - keep the stock scenario fixed and use LSTM as the target learner.

### Block 4: Singular stock battery (`ts_reg_mv`)

- [19-stock-close-linear-regression-mv.md](19-stock-close-linear-regression-mv.md) - revisit the stock scenario in the singular branch with formula-based multivariate linear regression.
- [20-stock-close-arimax-regression-mv.md](20-stock-close-arimax-regression-mv.md) - revisit the stock scenario in the singular branch with `ts_arimax()` and univariate support models for the auxiliaries.
- [21-stock-close-vector-autoregression-mv.md](21-stock-close-vector-autoregression-mv.md) - revisit the stock scenario in the singular branch with a joint vector autoregression that still keeps `close` as the distinguished target.

Objetivo: Treinar e avaliar um modelo Random Forest para previsão de séries temporais com janelas deslizantes, incluindo normalização, ajuste e visualização de resultados.


``` r
# Regressão de Série Temporal - Random Forest

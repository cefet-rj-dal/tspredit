Objetivo: Demonstrar a previsão de séries temporais com SVM (Support Vector Regression) usando janelas deslizantes, normalização, ajuste do modelo e avaliação com métricas e gráfico.


``` r
# Regressão de Série Temporal - SVM

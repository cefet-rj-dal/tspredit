...
About the technique
- Awareness augmentation gives more importance to windows that reflect the most recent regime of the series.
- This is useful when old patterns may be less relevant than recent dynamics.

Didactic goal: see how augmentation can encode temporal preference instead of only geometric variation.
...
![plot of chunk unnamed-chunk-3](fig/07-awareness-augmentation/unnamed-chunk-3-1.png)
...
![plot of chunk unnamed-chunk-4](fig/07-awareness-augmentation/unnamed-chunk-4-1.png)

Now we augmentation (awareness).
...
![plot of chunk unnamed-chunk-6](fig/07-awareness-augmentation/unnamed-chunk-6-1.png)

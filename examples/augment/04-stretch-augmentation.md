...
About the technique
- Stretch augmentation amplifies variations inside the window.
- It is useful for exposing the model to stronger local oscillations than those seen in the original sample.

Didactic goal: inspect how amplitude expansion creates alternative training windows while keeping the same temporal structure.
...
![plot of chunk unnamed-chunk-3](fig/04-stretch-augmentation/unnamed-chunk-3-1.png)
...
![plot of chunk unnamed-chunk-6](fig/04-stretch-augmentation/unnamed-chunk-6-1.png)
